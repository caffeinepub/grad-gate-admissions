...
export class Backend implements backendInterface {
    ...
    async getChannelPartners(): Promise<Array<ChannelPartner>> {
        if (this.processError) {
            try {
                const result = await this.actor.getChannelPartners();
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getStudentLeads(): Promise<Array<StudentLead>> {
        if (this.processError) {
            try {
                const result = await this.actor.getStudentLeads();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitChannelPartner(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitChannelPartner(arg0, arg1, arg2, arg3, arg4);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitStudentLead(arg0: string, arg1: string, arg2: string, arg3: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitStudentLead(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
